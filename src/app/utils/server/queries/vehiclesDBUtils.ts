...
export const stringForJoiningVehicleTables = `
		...
		"hybridVehicleData"(
    		"id", "vehicleID", "gasCostPerGallon", "milesPerGallonHighway", "milesPerGallonCity", "electricityCostPerKWh", "milesPerKWhHighway", "milesPerKWhCity", "percentElectricDriving"  
		),
